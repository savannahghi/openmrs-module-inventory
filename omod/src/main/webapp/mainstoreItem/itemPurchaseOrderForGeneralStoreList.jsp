...
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code='ehrinventory.purchaseItem.add'/>" onclick="ACT.go('itemPurchaseOrderForGeneralStore.form');"/>
<br /><br />

<form method="get"  id="form">
<table >
	<tr>
		<td><spring:message code="ehrinventory.purchaseItem.name"/></td>
		<td>
...
<br />
<span class="boxHeader"><spring:message code="ehrinventory.purchaseItem.list"/></span>
<div class="box">
<table width="100%" cellpadding="5" cellspacing="0">
	<tr>
	<th>S.No</th>
	<th><spring:message code="ehrinventory.purchaseItem.name"/></th>
	<th><spring:message code="ehrinventory.purchaseItem.createdOn"/></th>
	</tr>
	<c:choose>
