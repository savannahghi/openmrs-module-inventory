...
<spring:message var="pageTitle" code="ehrinventory.viewStockBalanceExpiry.manage" scope="page"/>
<%@ include file="/WEB-INF/template/header.jsp" %>
<%@ include file="nav.jsp" %>
<h2><spring:message code="ehrinventory.viewStockBalanceExpiry.manage"/></h2>
<br />
...
<table >
	<tr >
		...
		<td><spring:message code="ehrinventory.receiptDrug.attribute"/></td>
		<td>
...
<table width="100%" cellpadding="5" cellspacing="0">
    ...
    <th><spring:message code="ehrinventory.viewStockBalance.attribute"/></th>
